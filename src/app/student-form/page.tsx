...
export default function StudentForm() {
    ...
    return (
        < Card className="max-w-[400px] max-h-[1000px]" >
            ...
            <Divider />
            <CardBody className=" bordered h-[400px] flex place-content-evenly " >
                ...
                <div className=" text-red-500 flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                    <Input className="text-red-500" variant="bordered" type="email" label="Correo institucional" />
                </div>
